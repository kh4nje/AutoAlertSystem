...
if new_file is not None:
    ...
    if new_file.name.endswith('.xlsx'):
        ...
        # Check if disease_cols is empty
        if not disease_cols:
            st.error("No disease columns found in the new week data. Please check the file structure.")
            st.stop()
        ...
        # Dynamically add missing org levels as 'Unknown'
        for level in ['orgunitlevel1', 'orgunitlevel2', 'orgunitlevel
